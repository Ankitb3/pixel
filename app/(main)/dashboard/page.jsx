...
import NewProjectModal from "./_components/new_project_modal";
  ...
  return (
   <div className="min-h-screen pt-32 pb-16">
      <div className="container mx-auto px-6">
        ...
        {/* Projects Content */}
           {
            isLoading ? <BarLoader width={"100%"} color="white"/> : projects && projects.length > 1 ? <ProjectGrid projects={projects}/>:<div className="flex flex-col justify-center items-center py-20 text-center">
          ...
          >
           ...
           <NewProjectModal isOpen={showNewProjectModal}
            onClosed={()=>setShowNewProjectModal(false)}
           />
      </div>
    </div>
  );
