...
const Editor = () => {
  ...
  return (
    <CanvasContext.Provider value={{ activeTool, onToolChange: setActiveTool, canvasEditor, setCanvasEditor, processingMessage, setProcessingMessage }}>
      ...
      <div className='hidden lg:block min-h-screen bg-slate-900'>
        <div className='flex flex-col h-screen'>
          {
            processingMessage && <div className="fixed inset-0 bg-black/50 backdrop-blur-xs z-50 flex items-center justify-center">
          ...
          {/* Topbar */}
          <EditorTopBar projects={project} />
          <div className='flex flex-1 overflow-hidden'>
            <EditorSideBar projects={project} />
